...
public static class FruugoPanel
{
    public static FrameworkElement Create(string? directory = null)
    {
        ...
        root.Children.Add(new TextBlock { Text = "Retailer/API bilgileri DPAPI ile şifrelenir. Ürün sözleşmesi doğrulanmadan canlı veri değiştirilmez.", TextWrapping = TextWrapping.Wrap, Foreground = Brushes.DarkSlateGray, Margin = Spacing.BelowSection });
