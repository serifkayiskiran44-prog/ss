...
public partial class MainWindow : Window
{
 ...
 void BuildProducts()
 {
  ...
  Field(productEditor,"Üretici parça kodu / MPN","Mpn").MaxLength=128;Field(productEditor,"Menşei ülke (kod veya ad, örn. TR / Almanya)","CountryOfOrigin").MaxLength=64; /* #910 */
