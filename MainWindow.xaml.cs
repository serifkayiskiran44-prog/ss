...
public partial class MainWindow : Window
{
 ...
 void RefreshSources(bool choose=true){
  ...
  changingSourceList=true;try{sources.ItemsSource=view;if(selectedId!=null)sources.SelectedItem=ordered.FirstOrDefault(x=>x.Id==selectedId);}finally{changingSourceList=false;}
