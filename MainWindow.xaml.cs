...
public partial class MainWindow : Window
{
 ...
 IReadOnlyList<RowAction> SourceRowActions(){var none=sources.SelectedItem is XmlSource?null:"Önce kaynak seçin.";return new RowAction[]{new("source-inspect","XML'i oku / alanları bul",()=>RunGuarded(InspectAsync),none),new("source-health","Kaynak sağlığını kontrol et (tam okuma)",()=>RunGuarded(CheckXmlSourceAsync),none),new("source-delete","Kaynağı sil (kullanılmıyorsa)",()=>RunGuarded(DeleteSourceAsync),none,true)};}
