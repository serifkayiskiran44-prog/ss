...
public partial class MainWindow : Window
{
 ...
 public MainWindow(string? directory, HttpClient? httpClient = null)
 {
  ...
  InitializeComponent();FontFamily=DesignTokens.FontFamilyBody;FontSize=DesignTokens.TextBodySize;IconStyles.ApplyIconButton(BackButton,IconRole.Inline);BackButton.ToolTip = KeyboardShortcuts.Hint("Geri", "back"); GlobalSearchBox.ToolTip = KeyboardShortcuts.Hint("Genel arama", "global-search"); ShortcutsButton.ToolTip = KeyboardShortcuts.Hint("Klavye kısayolları", "shortcut-reference"); IconStyles.ApplyIconButton(ShortcutsButton, IconRole.Inline);RefreshBackButton();uiPreferences=PreferenceSchema.OpenStore(directory);WindowGeometry.Restore(this, uiPreferences);Language=System.Windows.Markup.XmlLanguage.GetLanguage(CultureInfo.CurrentCulture.IetfLanguageTag);
