...
public partial class MainWindow : Window
{
 ...
 void BuildProducts()
 {
  ...
  productEditor.Children.Add(productPriceSummaryPanel);productProvenanceExpander.Content=productProvenanceBody;productEditor.Children.Add(productProvenanceExpander);Field(productEditor,"Alış fiyatı","Cost").IsReadOnly=true;Field(productEditor,"Alış para birimi","CostCurrency").IsReadOnly=true;Field(productEditor,"Satış fiyatı","Price");Field(productEditor,"Satış para birimi","Currency").IsReadOnly=true;Field(productEditor,"KDV oranı (%)","VatRate");Field(productEditor,"Desi (kargo)","Desi");productEditor.Children.Add(Hint("Boş bırakılırsa boyuttan hesaplanır (U × G × Y / 3000) ve boyutu izler; elle girilen desi korunur.")); /* #908 */productEditor.Children.Add(Hint("XML güncellemesinde korunmasını istediğin alanı kilitle."));
