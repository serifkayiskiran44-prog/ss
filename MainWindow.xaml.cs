...
public partial class MainWindow : Window
{
 ...
 void ShowProducts(CatalogPage page){var id=edit?.Id;productTotal=page.Total;products.ItemsSource=page.Items;if(id!=null)products.SelectedItem=page.Items.FirstOrDefault(p=>p.Id==id);var corruptCount=store.CorruptProducts().Count;var corruptSuffix=corruptCount>0?$"   •   ⚠ {corruptCount:N0} bozuk kayıt (incelenmeli)":"";SummaryText.Text=$"{page.Total:N0} sonuç   •   {page.InStock:N0} stokta   •   {page.Linked:N0} Etsy ile eşleşen   •   Sayfa {productOffset/200+1} / {Math.Max(1,(page.Total+199)/200)}{corruptSuffix}";}
