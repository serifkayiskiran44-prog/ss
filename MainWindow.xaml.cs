...
public partial class MainWindow : Window
{
 ...
 void SetSource(XmlSource s)
 {
  ...
  var names=new[]{("Sku","SKU / stok kodu"),("Barcode","Barkod"),("Gtin","GTIN / EAN / UPC"),("Name","Ürün adı"),("Description","Açıklama"),("Cost","Alış fiyatı"),("Stock","Stok"),("Brand","Marka"),("Category","Kategori"),("ImageUrls","Görseller"),("Weight","Ağırlık (birimli: 1,5 kg / 1500 g)"),("Dimensions","Boyut (U x G x Y, birimli: 20 x 30 x 40 cm)"),("TaxClass","Vergi sınıfı (kod: standard, reduced, super-reduced, zero, exempt)")};
