...
public partial class MainWindow : Window
{
 ...
 async Task ScheduledAsync()
 {
  ...
  try{
   ...
   // XML having no due source must never skip due Stock/Price/Health/Sync automation jobs (#307): evaluate both independently before deciding to skip the tick.
   if(due.Count==0&&dueJobs.Count==0)return;
