...
public partial class MainWindow
{
 ...
 void BuildNavigation()
 {
  ...
  Page("bizimhesap","BizimHesap","Ürün ve depo okuma, XML ürün havuzuyla eşleştirme hazırlığı ve güvenli bağlantı ayarları.",BizimHesapPanel.Create(dataDirectory));
  ...
  foreach(var id in new[]{"etsy","ebay","ozon","joom","bizimhesap","amazon","trendyol","hepsiburada","fruugo","allegro","wish"})
