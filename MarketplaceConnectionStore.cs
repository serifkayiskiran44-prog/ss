...
public static class MarketplaceConnectionCatalog
{
    public static IReadOnlyList<MarketplaceConnectionDefinition> All { get; } = Array.AsReadOnly(new[]
    {
        ...
        new MarketplaceConnectionDefinition("hepsiburada", "Hepsiburada", "hepsiburada", new(new HashSet<MarketplaceOperation>{ MarketplaceOperation.ProductsRead, MarketplaceOperation.ProductManagement }), "https://developers.hepsiburada.com/tr/companies/hepsiburada", false),
