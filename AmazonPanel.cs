...
public static class AmazonPanel
{
    public static FrameworkElement Create(string? directory = null)
    {
        ...
        root.Children.Add(new TextBlock { Text = "Kimlik bilgileri Windows kullanıcı profiline DPAPI ile şifrelenir. Resmi bölge sözleşmesi doğrulanmadan canlı HTTP isteği yapılmaz.", TextWrapping = TextWrapping.Wrap, Foreground = Brushes.DarkSlateGray, Margin = Spacing.BelowSection });
