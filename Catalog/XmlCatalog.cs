...
public static class XmlCatalog
{
 ...
 public static void Validate(XmlSource s){if((s.PriceMode=="Simple"&&(s.ExchangeRate<=0||s.MarkupPercent< -100))||s.MinimumPrice<0||s.SafetyStock<0||s.MinimumStock<0||s.MaximumStock<0||s.IntervalMinutes<1||s.DecimalSeparator is not ("." or ",")||s.Currency.Length!=3)throw new InvalidOperationException("Kur, fiyat, stok, para birimi veya aralık geçersiz.");CatalogPricing.ValidateSettings(s);}
