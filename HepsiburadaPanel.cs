...
public static class HepsiburadaPanel
{
    public static FrameworkElement Create(string? directory = null)
    {
        ...
        root.Children.Add(new TextBlock { Text = "Merchant ve API bilgileri DPAPI ile şifrelenir. Resmi sözleşme doğrulanmadan ürün, stok, fiyat veya sipariş isteği oluşturulmaz.", TextWrapping = TextWrapping.Wrap, Foreground = Brushes.DarkSlateGray, Margin = Spacing.BelowSection });
        ...
        var state = new TextBlock { TextWrapping = TextWrapping.Wrap, Foreground = Brushes.DarkSlateGray, Margin = Spacing.VerticalControl }; root.Children.Add(state);
