...
public static class MessagePanel
{
    public static FrameworkElement Create(string? directory = null, Action<string>? navigate = null)
    {
        ...
        top.Children.Add(Text("Mesaj ve müşteri iletişim merkezi", 22));
        ...
        var info = Text("Bir mesaj seçin."); detail.Children.Add(Text("Mesaj ayrıntısı", 18)); detail.Children.Add(info);
