...
- Kullanıcının paylaştığı ana menü, ürün listesi, ürün formu ve XML ekran görüntülerinden çıkarılan özgün ekran gereksinimleri `docs/ENTEGRA-SCREEN-PARITY.md` içindedir ve bu belgeyle birlikte okunmalıdır.
