...
public partial class MainWindow
{
    FrameworkElement BuildTaxonomy()
    {
        ...
        var tabs = new TabControl(); tabs.Items.Add(new TabItem { Header = "Yerel sözlük", Content = localGrid }); tabs.Items.Add(new TabItem { Header = "Kanal / mağaza eşleme", Content = mappingGrid }); tabs.Items.Add(new TabItem { Header = "Eşleme geçmişi", Content = historyGrid }); tabs.Items.Add(new TabItem { Header = "Takma adlar", Content = aliasGrid }); /* #912 */ tabs.Items.Add(new TabItem { Header = "İnceleme kuyruğu", Content = reviewGrid }); /* #913 */ panel.Children.Add(tabs); panel.Children.Add(status); Refresh(); return Scroll(panel);
    }
}
