...
- Product-card order report now reads persisted local orders by selected SKU and shows order count, quantity and latest marketplace/shop/order. Two focused regression tests; full Release 123/123. Remaining product-card acceptance stays PARTIAL.
